public class Projectile extends SpaceObject
{
  ...
  {    
    setLocation(new Location(Game.DEFENDER_X,y+Game.CHARACTER_SIZE/2));
    setSpeed(16);
  ...
  {
    return "[Projectile: location=[" + getLocation() + "], projectileWidth=" + this.projectileWidth + ", projectileHeight=" + this.projectileHeight + ", speed=" + getSpeed() + "]";
  }
